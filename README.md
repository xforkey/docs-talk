...
![Preview](https://raw.githubusercontent.com/xforkey/docs-talk/main/docs/images/preview-graph.png)
...
```yml
+----------------------------------------------------------------------------+
| End users: Those who use apps built with `docs-talk`.                       |
| (You use an app like the one in the demo above)                            |
|     +----------------------------------------------------------------+     |
|     | Developers: Those who built with `docs-talk`.                   |     |
|     | (You have `import docs-talk` somewhere in your project)         |     |
|     |     +----------------------------------------------------+     |     |
|     |     | Contributors: Those who make `docs-talk` better.    |     |     |
...
![Preview](https://raw.githubusercontent.com/xforkey/docs-talk/main/docs/images/preview.png)

## Installation

> If you are not a developer and just want to use the app, please check out our easy-to-follow [User Guide](https://xforkey.github.io/docs-talk/). Download the `.zip` file from the [latest release](https://github.com/xforkey/docs-talk/releases/latest) to get all the newest features and bug fixes.
...
1. We support both `lite` & `full` version of Docker images. With `full`, the extra packages of `unstructured` will be installed as well, it can support additional file types (`.doc`, `.docx`, ...) but the cost is larger docker image size. For most users, the `lite` image should work well in most cases.
   ...
   - To use the `lite` version.
     ...
     -p 7860:7860 -it --rm \
     ghcr.io/xforkey/docs-talk:main-lite
     ```
   ...
   - To use the `full` version.
     ...
     -e GRADIO_SERVER_PORT=7860 \
     -p 7860:7860 -it --rm \
     ghcr.io/xforkey/docs-talk:main-full
     ```
...
4. We use [GHCR](https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-container-registry) to store docker images, all images can be found [here.](https://github.com/xforkey/docs-talk/pkgs/container/docs-talk)
...
1. Clone and install required packages on a fresh python environment.
   ...
   ```shell
   # optional (setup env)
   conda create -n docs-talk python=3.10
   conda activate docs-talk

   # clone this repo
   git clone https://github.com/xforkey/docs-talk
   cd docs-talk

   pip install -e "libs/docs-talk[all]"
...
<img src="https://raw.githubusercontent.com/xforkey/docs-talk/main/docs/images/pdf-viewer-setup.png" alt="pdf-setup" width="300">
...
4. Start the web server:
   ...
   ![Chat tab](https://raw.githubusercontent.com/xforkey/docs-talk/main/docs/images/chat-tab.png)
...
> We recommend most users to use NanoGraphRAG implementation for straightforward integration with docs-talk.
...
- `nano-graphrag` install might introduce version conflicts, see [this issue](https://github.com/xforkey/docs-talk/issues/440)
  - To quickly fix: `pip uninstall hnswlib chroma-hnswlib && pip install chroma-hnswlib`
- Launch docs-talk with `USE_NANO_GRAPHRAG=true` environment variable.
  ...
  - **Local Models**
    ...
    - Using `ollama` OpenAI compatible server:
      ...
      - Set the model names on web UI and make it as default:
        ...
        ![Models](https://raw.githubusercontent.com/xforkey/docs-talk/main/docs/images/models.png)
